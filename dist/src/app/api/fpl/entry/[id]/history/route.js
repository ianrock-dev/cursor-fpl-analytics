...
async function GET(request, { params }) {
    ...
    try {
        ...
        const response = await axios_1.default.get(`https://fantasy.premierleague.com/api/entry/${id}/history/`, {
            headers: {
        ...
        console.error('Error fetching FPL history data:', error.message);
        // Return detailed error information for debugging
        return server_1.NextResponse.json({
            error: 'Failed to fetch manager history data',
